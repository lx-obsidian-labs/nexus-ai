...
import { Sparkles, MessageSquare, Image, ArrowRight, Bot, Zap, Shield, Activity } from "lucide-react"
...
const features = [
  ...
  },
  {
    ...
    description: "Generate stunning images with FLUX Schnell, FLUX Dev, FLUX 1.1 Pro, and Stable Diffusion XL. Download, regenerate, and keep a history of all your creations.",
    highlights: ["Multiple image models", "High-resolution output", "Generation history"],
  },
]

const stats = [
  { label: "AI Models", value: "7+", icon: Activity },
...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col">
      <header className="fixed top-0 z-50 flex h-16 w-full items-center justify-between border-b bg-background/80 backdrop-blur-xl px-6">
      ...
      <main className="flex-1">
        <section className="relative overflow-hidden px-6 pt-36 pb-24">
          ...
          <div className="container mx-auto flex flex-col items-center text-center relative">
            <div className="mb-6 glass inline-flex items-center gap-2 rounded-full px-4 py-1.5 text-sm text-muted-foreground">
            ...
            <div className="mt-10 flex items-center gap-4">
              <Button size="lg" className="rounded-full shadow-lg shadow-primary/25 hover:shadow-xl hover:shadow-primary/30 transition-all duration-300" asChild>
                <Link href="/signup">
                  Get Started Free
        ...
        <section className="container mx-auto px-6 py-24">
          <div className="grid gap-8 md:grid-cols-2">
            {features.map((feature) => {
              ...
              return (
                <div key={feature.title} className="group glass-card p-8 transition-all duration-500 hover:shadow-lg hover:shadow-primary/10 hover:border-primary/30">
                  <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-primary/10 group-hover:bg-primary/15 transition-all duration-300 group-hover:scale-110">
              ...
              {stats.map((stat) => {
                ...
                return (
                  <div key={stat.label} className="group">
                    <div className="mb-3 inline-flex h-12 w-12 items-center justify-center rounded-xl bg-primary/10 group-hover:scale-110 transition-transform duration-300">
                      <Icon className="h-6 w-6 text-primary" />
                    </div>
